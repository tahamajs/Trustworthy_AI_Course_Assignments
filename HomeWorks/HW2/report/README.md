...
- Table "Top Two Correlation Pairs" in the template: values are generated by `code/generate_report_plots.py` and written to `figures/metrics_summary.json` under `top_correlation_pairs`; you can copy from there to keep the table in sync.
